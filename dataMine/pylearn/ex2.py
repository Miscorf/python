...
def mineTree(inTree, headerTable, minSup, preFix, freqItemList):
    bigL = [v[0] for v in sorted(headerTable.items(), key=lambda b: b[0])]
...
if __name__ == '__main__':
    ...
    freqItems = []
    mineTree(myFPtree, myHeaderTab, minSupport, set([]), freqItems)
    for i in range(len(freqItems)):
        print(freqItems[i], end=' ')
        print()
    print('\n', "=" * 100)
    minSupport = eval(input("input minSupport = "))